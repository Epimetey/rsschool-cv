# Sergei Pustovoi
![my_Photo](/img/my_ph.jpg)

## Contacts
   * **Tel:** _+7 961-951-961-8 (tg, wa)_ 
...
## About me
   - **Age:** _42_
   - **Sex:** _male_
   - **Profession:** _content manager_
   - **My goal:** _I want to master modern programming. The goal is to work as a full-stack or back-end programmer. But, at the beginning, I want to learn the front-end._
## Skills 
   - **Python**
...
## Education 
   - Programming  
      ...
      - JavaScript _(none)_      
         + _RS School_
      - Delphy _(average)_      
         + _Independent learning. Several PC applications were written (15-20 years ago)_         
   - Other 
      - Electrical engineer
      - Cand. Sc. (Agriculture)
